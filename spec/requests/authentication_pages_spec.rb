  ...
  describe "authorization" do
    ...
    describe "for non-signed-in users" do
      ...
      describe "in the Users controller" do
        ...
        #test for the authorization of the following and followers pages.
      ...
      #test for the relationships controller authorization
      ...
      #access control test for microposts
